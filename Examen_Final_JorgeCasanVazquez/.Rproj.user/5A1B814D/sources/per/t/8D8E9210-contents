#EXAMEN FINAL GESTIÓN DEL RIESGO OPERATIVO-CUNEF- 
# 5 de Junio 2019
# JORGE CASAN VÁZQUEZ

#Librerias básicas para trabajar
...
#Graficamos la distribución de la cuantias
...
#Valor mínimo: 193.055
#	Número de iteraciones: 72
#Parámetro de posición: 6.404e+04, este es el parámetro µ que se corresponde con la localización
#Parámetro de escala: 2.28e+04, este es el parámetro σ
#Parámetro de forma: 8.177e-01, este es el parámetro ξ, indica el tamaño de la cola de la distribución.
...
#Parámetro de posición: 6.80e+04, este es el parámetro µ que se corresponde con la localización
#Parámetro de escala: 1.98e-01, este es el parámetro σ
